...
class OwnerRestControllerTest {
    ...
    public void setup() {
        owner = new Owner("Massimo", "Pitagora", LocalDate.of(1990, 1, 1), "pitagora@gmail.com", "male", "ROLE_OWNER", "password",null);
    ...
    public void testCreateOwnerWithExistingEmail(){
        ...
        Owner owner1 = new Owner("Massimo", "Parolo", LocalDate.of(1980, 12, 3), "pitagora@gmail.com", "male", "ROLE_OWNER", "1234", null);
    ...
    public void testCreateOwnerWithInvalidBDate(){
        //Vado a creare un nuovo Owner con la stessa mail di quello nel setup
        Owner owner1 = new Owner("Massimo", "Parolo", LocalDate.of(3000, 12, 3), "parolo@example.com", "male", "ROLE_OWNER", "1234", null);
    ...
    public void testUpdateOwnerSuccess() {
        ...
        Owner updatedOwner = new Owner("nomeAggiornato", "cognomeAggiornato", LocalDate.of(1990, 1, 1), "email@example.com", "male", "ROLE_OWNER", "newPassword", null);
    ...
    public void testUpdateOwnerNotFound() {
        ...
        Owner updatedOwner = new Owner("nomeAggiornato", "cognomeAggiornato", LocalDate.of(1990, 1, 1), "nonExistingEmail@example.com", "male", "ROLE_OWNER", "newPassword", null);
